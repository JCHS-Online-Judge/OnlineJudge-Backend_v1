...
public class ExceptionFactory {
	...
	public enum Type {
		...
		BOARD_NOT_FOUND("존재하지 않는 게시글입니다."), FILE_IS_EMPTY("파일이 비어있습니다."), FILE_NOT_FOUND("존재하지 않는 파일입니다."),

		LECTURE_NOT_FOUND("존재하지 않는 수업입니다."),

		CONTEST_NOT_FOUND("존재하지 않는 대회입니다."), ALREADY_EXIST_CONTEST_TITLE("이미 존재하는 대회 제목입니다."), ALREADY_JOINED_CONTEST(
				"이미 참가한 대회입니다."), NOT_JOINED_CONTEST("참가하지 않은 대회입니다."),
